								...
								switch (e2.length)
								{
									case 7:
										...
										if ( eNew.length === 5 )
										{
											...
											{
												name = eNew[0].data + '\t||\t' + eNew[3].data;
												place = clearPlace(eNew[1].data) + '\t||\t' + clearPlace(eNew[4].data);
											...
											{
												name = eNew[0].data + '\t||\t' + eNew[2].data;
												place = clearPlace(eNew[1].data) + '\t||\t' + clearPlace(eNew[3].data);
										...
										return { time, name, place, person, personId, group, status: 1 }
