...
// if ( group_name === '14503.1') { debugger; }
							try
							{
								switch (e2.length)
								{
									...
									case 7:
										...
										return { time, name, day: dayCount, place, person, personId, group_name, position, status: 1 }

									case 3:				// all data were provided
										return {
											time,
											name: e2[0].data, day: dayCount,
									...
									case 1:				// shoud be empty, but in case it's a class without a tutor and a place
										...
										else
										{
											return {
												name: e2[0].data,
												time, day: dayCount, place: '', person: '', personId: 1, group_name, position,
												status: 1
											}
										}
